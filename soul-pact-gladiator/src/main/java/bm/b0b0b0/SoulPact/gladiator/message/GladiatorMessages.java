...
public final class GladiatorMessages {
    ...
    public GladiatorMessages(JavaPlugin plugin, String locale, String fallbackLocale) {
        this.plugin = plugin;
        this.locale = locale;
    ...
    public void load() {
        ...
        try (Stream<java.nio.file.Path> paths = Files.list(langFolder.toPath())) {
            ...
            plugin.getLogger().severe("Failed to load gladiator lang: " + exception.getMessage());
        }
    }
    ...
    public Component component(Player player, String key, Map<String, String> placeholders) {
        return GladiatorTextParser.parse(resolve(player, key, placeholders));
    }

    public Component componentDefault(String key, Map<String, String> placeholders) {
        return GladiatorTextParser.parse(resolveDefault(key, placeholders));
    }
    ...
    public void send(CommandSender sender, String key, Map<String, String> placeholders) {
        ...
        sender.sendMessage(GladiatorTextParser.parse(resolveDefault(key, placeholders)));
    }
    ...
    private void copyDefault(String fileName, File langFolder) {
        ...
        try (InputStream stream = plugin.getResource("lang/" + fileName)) {
            ...
            plugin.getLogger().severe("Failed to copy gladiator lang " + fileName + ": " + exception.getMessage());
        }
    }
}
