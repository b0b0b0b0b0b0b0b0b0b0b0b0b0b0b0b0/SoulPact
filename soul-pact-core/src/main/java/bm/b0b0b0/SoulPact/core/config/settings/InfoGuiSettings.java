...
public final class InfoGuiSettings {
    ...
    public InfoGuiSlotsSettings slots = new InfoGuiSlotsSettings();

    @NewLine
    @Comment(@CommentValue("Material для иконок (имена Bukkit)"))
    public InfoGuiMaterialsSettings materials = new InfoGuiMaterialsSettings();
}
