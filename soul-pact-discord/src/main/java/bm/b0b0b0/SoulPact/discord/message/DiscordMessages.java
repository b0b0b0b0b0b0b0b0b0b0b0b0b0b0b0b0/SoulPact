...
public final class DiscordMessages {
    ...
    public DiscordMessages(JavaPlugin plugin, String locale, String fallbackLocale) {
        this.plugin = plugin;
        this.locale = locale;
    ...
    public void load() {
        ...
        try (Stream<java.nio.file.Path> paths = Files.list(langFolder.toPath())) {
            ...
            plugin.getLogger().severe("Failed to load discord lang: " + exception.getMessage());
        }
    }
    ...
    private void copyDefault(String fileName, File langFolder) {
        ...
        try (InputStream stream = plugin.getResource("lang/" + fileName)) {
            ...
            plugin.getLogger().severe("Failed to copy discord lang " + fileName + ": " + exception.getMessage());
        }
    }
}
